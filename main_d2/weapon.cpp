...
uint8_t Secondary_weapon_to_gun_num[MAX_SECONDARY_WEAPONS] = { 4,4,7,7,7,4,4,7,4,7 };

int Primary_ammo_max[MAX_PRIMARY_WEAPONS] = { 0, VULCAN_AMMO_MAX, 0, 0, 0, 0, VULCAN_AMMO_MAX, 0, 0, 0 };
uint8_t Secondary_ammo_max[MAX_SECONDARY_WEAPONS] = { 20, 10, 10, 5, 5, 20, 20, 15, 10, 10 };

//for each primary weapon, what kind of powerup gives weapon
uint8_t Primary_weapon_to_powerup[MAX_PRIMARY_WEAPONS] = { POW_LASER,POW_VULCAN_WEAPON,POW_SPREADFIRE_WEAPON,POW_PLASMA_WEAPON,POW_FUSION_WEAPON,POW_LASER,POW_GAUSS_WEAPON,POW_HELIX_WEAPON,POW_PHOENIX_WEAPON,POW_OMEGA_WEAPON };
...
uint8_t PrimaryOrder[] = { 9,8,7,6,5,4,3,2,1,0,255 };
uint8_t SecondaryOrder[] = { 9,8,4,3,1,5,0,255,7,6,2 };

uint8_t DefaultPrimaryOrder[] = { 9,8,7,6,5,4,3,2,1,0,255 };
uint8_t DefaultSecondaryOrder[] = { 9,8,4,3,1,5,0,255,7,6,2 };
...
uint8_t Primary_last_was_super[MAX_PRIMARY_WEAPONS];
uint8_t Secondary_last_was_super[MAX_SECONDARY_WEAPONS];
...
//	Looks like a debug screen now because it writes to mono screen, but that will change... //[ISB] it still hasn't...
...
{
	uint16_t old_flags = Players[Player_num].primary_weapon_flags;
	uint16_t flag = 1 << weapon_index;
	int cutpoint;
